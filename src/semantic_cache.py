...
from config import CACHE_SIMILARITY_THRESHOLD, CACHE_RECENT_LIMIT

CACHE_COLLECTION = "llm_cache"
# 코사인 유사도 임계값 (조정 가능)
SIMILARITY_THRESHOLD = CACHE_SIMILARITY_THRESHOLD
_CACHE_COLLECTION_READY = False


def ensure_cache_collection(client: QdrantClient | None = None) -> None:
    """llm_cache 컬렉션이 없으면 생성합니다."""
    global _CACHE_COLLECTION_READY
    if _CACHE_COLLECTION_READY:
        return
...
def list_recent_cached_queries(limit: int = CACHE_RECENT_LIMIT) -> list[dict]:
